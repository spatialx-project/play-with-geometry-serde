 ...
 * "License"); you may not use this file except in coShapeSerdempliance
 ...
 * number of vertexes, 16 * num-vertexes for XY coordinates of all the vertexes. Polygons is
 * serialized as MultiPolygon. MultiPolygon: 16 bytes for envelope, 4 bytes for the total number of
 * exterior and interior rings of all polygons, 4 bytes for total number of vertexes, 16 *
 * num-vertexes for XY coordinates of all the vertexes. The vertexes are written one polygon at a
