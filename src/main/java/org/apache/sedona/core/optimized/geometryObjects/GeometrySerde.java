...
package org.apache.sedona.core.optimized.geometryObjects;
...
import org.apache.sedona.core.optimized.formatMapper.shapefileParser.parseUtils.shp.ShapeSerde;
...
public class GeometrySerde extends Serializer implements Serializable {
  ...
  public void write(Kryo kryo, Output out, Object object) {
    if (object instanceof Point
        ...
        || object instanceof MultiPoint
        || object instanceof MultiLineString
        || object instanceof MultiPolygon) {
